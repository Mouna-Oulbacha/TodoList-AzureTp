...
exports.AzureAppServiceMockTests = void 0;
...
function start(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to start App Service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME'. Error: internal error occurred (CODE: 501)"), 'Should have printed Error: Failed to start App Service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME. Error: internal error occurred (CODE: 501)');
}
function stop(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to stop App Service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME'. Error: internal error occurred (CODE: 501)"), 'Should have printed Error: Failed to stop App Service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME. Error: internal error occurred (CODE: 501)');
}
function restart(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to restart App Service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME'. Error: internal error occurred (CODE: 501)"), 'Should have printed Error: Failed to restart App Service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME. Error: internal error occurred (CODE: 501)');
}
...
function swap(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to swap App Service 'MOCK_APP_SERVICE_NAME' slots - 'MOCK_SLOT_NAME' and 'MOCK_TARGET_SLOT'. Error: one of the slots is in stopped state. (CODE: 501)"), 'Should have printed: Error: Failed to swap App Service MOCK_APP_SERVICE_NAME slots - MOCK_SLOT_NAME and MOCK_TARGET_SLOT. Error: one of the slots is in stopped state. (CODE: 501)');
}
function swapSlotWithPreview(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to swap Phase 1 configuration changes for App Service 'MOCK_APP_SERVICE_NAME' slots - 'MOCK_SLOT_NAME' and 'MOCK_TARGET_SLOT'. Error: one of the slots is in stopped state. (CODE: 501)"), 'Should have printed: Error: Failed to swap Phase 1 configuration changes for App Service MOCK_APP_SERVICE_NAME slots - MOCK_SLOT_NAME and MOCK_TARGET_SLOT. Error: one of the slots is in stopped state. (CODE: 501)');
}
function cancelSwapSlotWithPreview(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to cancel swap Phase 1 configuration changes for App Service 'MOCK_APP_SERVICE_NAME' slot -'MOCK_SLOT_NAME'. Error: slot is in stopped state. (CODE: 501)"), 'Should have printed: Error: Failed to cancel swap Phase 1 configuration changes for App Service MOCK_APP_SERVICE_NAME slot -MOCK_SLOT_NAME. Error: slot is in stopped state. (CODE: 501)');
}
function get(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to fetch App Service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME' details. Error: internal error occurred (CODE: 501)"), 'Should have printed: Error: Failed to fetch App Service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME details. Error: internal error occurred (CODE: 501)');
}
...
function getPublishingProfileWithSecrets(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to fetch App Service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME' publishing profile. Error: internal error occurred (CODE: 501)"), 'Should have printed: Error: Failed to fetch App Service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME publishing profile. Error: internal error occurred (CODE: 501)');
}
function getPublishingCredentials(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to fetch App Service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME' publishing credentials. Error: internal error occurred (CODE: 501)"), 'Should have printed: Error: Failed to fetch App Service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME publishing credentials. Error: internal error occurred (CODE: 501)');
}
function getApplicationSettings(tr) {
    ...
    assert(tr.stdOutContained("Error: Failed to get App service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME' application settings. Error: internal error occurred (CODE: 501)"), 'Should have printed: Error: Failed to get App service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME application settings. Error: internal error occurred (CODE: 501)');
}
function updateApplicationSettings(tr) {
    assert(tr.stdOutContained('MOCK_APP_SERVICE_NAME APPSETTINGS ID: /subscriptions/MOCK_SUBSCRIPTION_ID/resourceGroups/vincaAzureRG/providers/Microsoft.Web/sites/MOCK_APP_SERVICE_NAME/config/appsettings'), 'Should have printed: MOCK_APP_SERVICE_NAME APPSETTINGS ID: /subscriptions/MOCK_SUBSCRIPTION_ID/resourceGroups/vincaAzureRG/providers/Microsoft.Web/sites/MOCK_APP_SERVICE_NAME/config/appsettings');
    assert(tr.stdOutContained("Error: Failed to update App service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME' application settings. Error: internal error occurred (CODE: 501)"), 'Should have printed: Error: Failed to update App service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME application settings. Error: internal error occurred (CODE: 501)');
}
...
function updateConfiguration(tr) {
    assert(tr.stdOutContained('MOCK_APP_SERVICE_NAME CONFIG_WEB ID: /subscriptions/MOCK_SUBSCRIPTION_ID/resourceGroups/vincaAzureRG/providers/Microsoft.Web/sites/MOCK_APP_SERVICE_NAME/config/web'), 'Should have printed: MOCK_APP_SERVICE_NAME CONFIG_WEB ID: /subscriptions/MOCK_SUBSCRIPTION_ID/resourceGroups/vincaAzureRG/providers/Microsoft.Web/sites/MOCK_APP_SERVICE_NAME/config/web');
    assert(tr.stdOutContained("Error: Failed to update App service 'MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME' configuration. Error: internal error occurred (CODE: 501)"), 'Should have printed: Error: Failed to update App service MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME configuration. Error: internal error occurred (CODE: 501)');
}
function patchConfiguration(tr) {
    ...
    assert(tr.stdOutContained('Error: FailedToPatchAppServiceConfiguration MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME internal error occurred (CODE: 501)'), 'Should have printed: Error: FailedToPatchAppServiceConfiguration MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME internal error occurred (CODE: 501)');
}
function getMetadata(tr) {
    ...
    assert(tr.stdOutContained('Error: FailedToGetAppServiceMetadata MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME internal error occurred (CODE: 501)'), 'Should have printed: Error: FailedToGetAppServiceMetadata MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME internal error occurred (CODE: 501)');
}
function updateMetadata(tr) {
    ...
    assert(tr.stdOutContained('Error: FailedToUpdateAppServiceMetadata MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME internal error occurred (CODE: 501)'), 'Should have printed: Error: FailedToUpdateAppServiceMetadata MOCK_APP_SERVICE_NAME-MOCK_SLOT_NAME internal error occurred (CODE: 501)');
}
